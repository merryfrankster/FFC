...
(function() {
    ...
    const seoConfig = {
        ...
        "/terms-and-conditions": { "title": "Maui Car Rental Terms And Conditions Frank's Friendly Cars", "description": "Rates, fees, charges, restrictions, penalties, policies, refunds, eligibility, et cetera. For any questions, please call 808-280-1196 or email info@mauicarrental.biz." },
        "/refund-policy": { "title": "Maui Car Rental Refund Policy Frank's Friendly Cars", "description": "For info on how to get a refund, call our customer service at 808-280-1196 or email info@mauicarrental.biz" },
        "/privacy-policy": { "title": "Maui Car Rental Privacy Policy Frank's Friendly Cars", "description": "What info we collect and what we do with it. We do not share your personal info or sell it." },
        "/info": { "title": "Maui Car Rental Info From Frank's Friendly Cars", "description": "Explore Maui car rental vehicles, locations, special offers, company profile. For any questions, call 808-280-1196 or email info@mauicarrental.biz." },
        "/blog": { "title": "Maui Car Rental Blog - News, Price Tracker, Forecasts, Deals", "description": "Maui car rental news and survey of lowest advertised prices updated weekly. Historical price data with charts. How much does it cost to rent a car in Maui?" },
        "/merchant-policies": { "title": "Maui Car Rental Merchant Policies Frank's Friendly Cars", "description": "Delivery time, processing options, payment methods, deposits, refunds. For any questions, please call 808-280-1196 or email info@mauicarrental.biz." },
        "/legal-notice": { "title": "Maui Car Rental Legal Notice From Frank's Friendly Cars", "description": "Required legal notices. Business name, registered company name. Call 808-280-1196 or email info@mauicarrental.biz with any questions." },
        "/price-list": { "title": "Maui Car Rental Price List From Frank's Friendly Cars", "description": "How much does it cost to rent a car. Call 808-280-1196 or email info@mauicarrental.biz with any questions." },
        "/reviews": { "title": "Maui Car Rental Reviews For Frank's Friendly Cars", "description": "Hundreds of 5-star reviews from Maui car rental customers on Google, Yelp, Tripadvisor. Repeat visitors choose us for convenient pickup & affordable rates!" },
        ...
        "/contact-us": { "title": "Maui Car Rental Contact Options For Frank's Friendly Cars", "description": "Maui car rental contact info: tel:808-280-1196, email:info@mauicarrental.biz, pickup locations, mailing address, booking, maps & directions, social media." },
        "/podcast": { "title": "Maui Car Rental Podcast from Frank's Friendly Cars", "description": "Engaging audio and video series cover Maui car rental news, price tracker, special deals, and related information. Subscribe on your podcast provider." },
        "/services": { "title": "Cars & Rates, Special Deals From Frank's Friendly Cars", "description": "See special offers on cars and services, list of available vehicles for Maui car rental, new cars with low miles, and affordable older cars." },
